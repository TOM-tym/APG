...
DevArray=(${DEVICES//,/ })
NumGpus=${#DevArray[@]}
LABEL=CIFAR100_tinyImageNet_pretrained_vitbase_B10_T10
...
Config_stage1=options/continual_trans/pretrained/CIFAR100_tinyImageNetPretrained_incremental_vitbase.yaml
