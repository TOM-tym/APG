...
DevArray=(${DEVICES//,/ })
NumGpus=${#DevArray[@]}
LABEL=ImageNetR_tinyImageNet_pretrained_vitbase_B10_T10
...
Config_stage1=options/continual_trans/pretrained/imagenetR_tinyImageNetPretrained_incremental_vitbase.yaml
